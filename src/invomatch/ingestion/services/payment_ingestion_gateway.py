...
from invomatch.ingestion.services.duplicate_classifier import classify_payment_duplicate
from invomatch.ingestion.services.payment_ingestion_service import ingest_payment_input


class PaymentIngestionGateway:
    def __init__(self, repository: IngestionRepository) -> None:
        self._repository = repository

    def ingest(self, raw: RawPaymentInput) -> PersistedIngestionOutcome:
        ...
        duplicate_check = classify_payment_duplicate(
            current=result,
